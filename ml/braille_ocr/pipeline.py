        ...
        for line in grid_lines:
            ...
            for c_idx, cell in enumerate(line):
                ...
                if needs_dot6_inspection:
                    ...
                    # Dot 6 recovery pass: 25% lower activation threshold
                    # (0.80 baseline * 0.75 = 0.60; minimal gradient relief: r6 >= 2.0 and norm_r6 > norm_r3 * 0.50)
                    dot6_active = (norm_r6 > norm_r3 * 0.60) or (r6 >= 11.25) or (r6 >= 2.0 and norm_r6 > norm_r3 * 0.50)
                    ...
                    if is_candidate_ed:
                        ...
                        if dot6_active:
                            dots[5] = 1
                            changed = True
                    elif is_q or (has_d3_no_d6 and norm_r6 > norm_r3 * 1.15):
                        # Dot 6 has higher local relief than Dot 3 shadow -> 'er'
                        if dot6_active or (is_q and norm_r6 > norm_r3 * 0.60):
                            dots[2] = 0
                            dots[5] = 1
                            changed = True
